...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    padded and adjustable shoulder straps and a front compartment for additional storage.
    Laptop sleeve dimensions: 18"h x 11"w x 1.5"d; fits most 15" laptops.
    Printed with the GEICO logo to match the trim.`,
    'category': 'office',
  ...
  },
  {
    ...
    Vinyl accents and antique hardware.`,
    'category': 'office',
  ...
  },
  {
    ...
    and a receipt or memo pocket. Two additional pen ports on padfolio cover.
    This case fits iPad, Kindle Fire HD 8.9", Nook HD+, or other 9-10" Tablets or eReaders..
    Also includes 8.5" x 11" writing pad, everything you could need all in one! Navy blue with GEICO debossed on the cover`,
    'category': 'office',
  ...
  },
  {
    ...
    Features a USB output and Micro USB Input (Cord Included to recharge after use).
    Charges most phones, MP3 Players and more! Output: 5 Volts/0.8 Amp.
    Requires your phone’s charging cord to charge your device. In silver with the GEICO Logo in Blue.`,
    'category': 'tech',
  ...
  },
  {
    ...
    you will be well prepared for any weather that comes your way!
    Blue and white with the GEICO logo printed on a white panel. Every umbrella comes in a nylon/mesh case.`,
    'category': 'outdoor',
  ...
  },
  {
    ...
    Royal blue with the GEICO logo printed in white on the front pocket.`,
    'category': 'outdoor',
